<template>
    <div>
        <el-table ref="multipleTable" :data="tableData" tooltip-effect="dark" style="width: 100%"
            ...
            <el-table-column prop="groupId" label="群组id" show-overflow-tooltip></el-table-column>
            ...
            <el-table-column prop="sendTime" label="日期" width="200">
...
<script>
import { getGroupMsgList } from '@/api/GroupMsg.js'
export default {
    data() {
        return {
            query: {
    ...
    methods: {
        getPage() {
            getGroupMsgList(this.query).then(res => {
                res = res.data
